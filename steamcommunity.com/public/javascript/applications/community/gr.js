  ...
  [5710],
  {
    ...
    37796: (e, t, r) => {
      ...
      class C {
        ...
        BIsSteamApp() {
          return this.GetType() === i.b7.k_EGameIDTypeApp;
        }
        BIsShortcut() {
          return this.GetType() === i.b7.k_EGameIDTypeShortcut;
        }
        BIsMod() {
          return this.GetType() === i.b7.k_EGameIDTypeGameMod;
        }
        BIsP2PFile() {
