  ...
  [9456],
  {
        ...
        return a.createElement(r.XZ.Consumer, null, function (e) {
          ...
          var s = b || e.location,
            ...
            R = A
              ...
              : null,
            N = !!(S ? S(R, s) : R),
            B = "function" == typeof h ? h(N) : h,
            P = "function" == typeof v ? v(N) : v;
          N &&
            ((B = (function () {
              for (
            ...
            (P = (0, o.A)({}, P, m)));
          var D = (0, o.A)(
            { "aria-current": (N && n) || null, className: B, style: P, to: i },
            w,
          );
          return (
            _ !== f ? (D.ref = t || j) : (D.innerRef = j), a.createElement(g, D)
          );
        });
      });
    },
              ...
              children: [
                ...
                s &&
                  (0, r.jsx)(u.s, {
                    ...
                    justify: "center",
                    align: "center",
                    children: (0, r.jsx)(h, { size: t, color: a, variant: i }),
                  }),
              ],
            })
          : (0, r.jsx)(h, { size: t, color: a, variant: i, ...o });
      }
      function h(e) {
        const { className: t, color: s, ...n } = (0, l.mz)(e, g);
        return (0, r.jsx)("div", {
          "data-accent-color": s,
          className: a()(t, d.Spinner),
          ...n,
        });
      }
      const g = [
    ...
    57757: (e, t, s) => {
      ...
      function d(e) {
        ...
        return (0, r.jsxs)(n.s, {
          ...
          "data-state": p(t),
          className: c()(o.Root, o[`Variant-${m}`], a && o.Disabled),
          onClick: x,
          tabIndex: 0,
          onKeyDown: (e) => {
            a ||
              (" " === e.key && (x(), e.preventDefault(), e.stopPropagation()));
          },
          cursor: "default",
          "aria-disabled": a,
          "data-accent-color": h,
          ...
          children: [
            (0, r.jsx)("div", {
              ...
              children: t && (0, r.jsx)(f, { className: o.Icon }),
            }),
            l,
          ],
        });
    ...
    86632: (e, t, s) => {
      ...
      function m(e) {
        ...
        return (0, r.jsx)(m.Root, {
          ...n,
          children: t.map((e) =>
            (0, r.jsx)(m.Item, { value: e, children: s(e) }, e),
          ),
        });
      }
      function h(e) {
      ...
      (m.Item = function (e) {
        ...
        (m.Root = function (e) {
          const {
            ...
            [f, x] = (0, n.useState)({}),
            S = (0, n.useCallback)((e, t) => x((s) => ({ ...s, [t]: e })), []),
            b = (0, n.useCallback)(
              (e, t) =>
                x((s) => {
                  const r = { ...s };
          ...
          return (0, r.jsx)(a.j, {
            ...
            radius: s,
            size: l,
            className: c()(d.SegmentedControlBox, d[`Variant-${t}`]),
            tabIndex: 0,
            onKeyDown: (e) => {
              let t = 0;
              switch (e.key) {
              ...
              if (t) {
                const s = Array.from(Object.values(f)).sort(g);
                let r;
                if (null === m) r = t > 0 ? 0 : s.length - 1;
                else {
                  const e = f[m],
                    n = s.findIndex((t) => t === e);
                  (0, o.wT)(
            ...
            children: (0, r.jsx)(u.Provider, {
              ...
              children: (0, r.jsxs)(i.az, {
                ...
                children: [p, null !== m && (0, r.jsx)(h, { radius: s })],
              }),
            }),
          });
        });
    ...
    57876: (e, t, s) => {
      ...
      function g(e, t) {
        ...
        if (t.only_current_platform && s.BHasPlatformPreferenceSet()) {
          if (
            !(
              (e.GetPlatforms()?.windows && s.BIsPreferredPlatform("win")) ||
              (e.GetPlatforms()?.mac && s.BIsPreferredPlatform("mac")) ||
        ...
        return !t.virtual_reality &&
          ...
          ? l.by.k_RejectNoVR
          : e.GetAllCreatorClanIDs()?.some((e) => s.BIsIgnoringCurator(e))
    ...
    55263: (e, t, s) => {
      ...
      function m(e, t, s, r) {
        ...
        if (
          ...
          }, [e, t, r, g, f, x, S, b, y, C, v, I, j, w, A, R, N, B, P, D, h]),
          !e)
        )
          return [null, p];
      ...
      function x(e, t, s, r) {
        ...
        if (
          ...
          }, [e, t, r, i, o, m, h, g, _, f, x, S, b, y, C, v, I, j, w, A]),
          !e)
        )
          return p;
        if (
    ...
    94841: (e, t, s) => {
          ...
          (function (e, t, s, r, n) {
            return {
              ...
              queryFn: async () => {
                ...
                if (l.data)
                  return Object.entries(l.data)
                    .map(([e, t]) => ({
                      nAppID: Number(e),
                      fDistance: Number(t),
                    }))
                    .filter((t) => t.fDistance > 0 && !e.includes(t.nAppID))
                    .sort((e, t) => t.fDistance - e.fDistance);
      ...
      function c() {
        return (0, o.I)({
          ...
          queryFn: async () => {
            let e = { sessionid: i.TS.SESSIONID };
            const t = await a().get(
      ...
      const f = Object.assign(
        ...
        { Root: S, Track: y, Range: C, Handle: v },
      );
          ...
          children: (0, r.jsx)("div", {
              ...
              if (p.current) {
                if (
                  ...
                  const t = p.current.getBoundingClientRect(),
                    s = I(e.clientX - t.left, [0, t.width], [a, i]);
                  m.current = { activeValueIndex: b(l, s), bMoved: !1 };
                } else m.current = { activeValueIndex: 0, bMoved: !1 };
                f(!0);
              }
            },
            onPointerUp: (e) => {
            ...
            onPointerMove: (e) => {
              if (
                ...
                const t = p.current.getBoundingClientRect(),
                  s = j({
                    value: I(e.clientX - t.left, [0, t.width], [a, i]),
                    min: a,
                    max: i,
                    step: c,
                  }),
                  r = [...l];
                (r[m.current.activeValueIndex] = s),
                  r.sort((e, t) => e - t),
                  (m.current.activeValueIndex = r.indexOf(s)),
                  (m.current.bMoved = !0),
                  o(r);
              }
            },
            onClick: (e) => {
              if (!p.current || m.current?.bMoved) return;
              const t = p.current.getBoundingClientRect(),
                s = I(e.clientX - t.left, [0, t.width], [a, i]),
            ...
            children: (0, r.jsx)("div", { className: g.Inner, children: t }),
          }),
        });
      }
      function b(e, t) {
      ...
      var O = s(49560),
        ...
        L = s(85585),
        k = s(8527);
      const T = (0, u.createContext)(null);
      function E(e) {
        return k.TS.IN_GAMEPADUI
          ? (0, r.jsx)(z, { ...e })
          : (0, r.jsx)(F, { ...e });
      }
      function z(e) {
      ...
      const G = function (e) {
          ...
          return (0, r.jsx)(T.Provider, { value: s, children: t });
        },
        U = function (e) {
          const { children: t } = e,
            s = u.Children.only(t),
            r = (0, u.useContext)(T),
            n = (0, R.SV)([r?.floating.refs.setReference, s?.props.ref]);
          if (!s) return null;
          if (!r)
            return (
              console.error(
      ...
      function ee(e, t) {
        const { onSelectionChange: s, selectedValue: r, ...n } = e,
          ...
          l = (0, u.useCallback)(
            (e) => {
              o(t ? [] : null), e.stopPropagation(), e.preventDefault();
            },
            [o, t],
          ),
          c = (0, u.useCallback)(
            (e) => {
              if (t) {
                const t = r,
                  s = t.indexOf(e);
                if (-1 !== s) return o(t.slice(0, s).concat(t.slice(s + 1)));
                o(t.concat(e));
              } else o(e);
            },
            [o, r, t],
      ...
      const te = {
        Root: function (e) {
          const {
            ...
            g = {
              ...
              refPopover: h,
              setOpen: (e) => {
                e && c(s.multiselect ? s.selectedValue[0] : s.selectedValue),
                  s.setOpen(e);
              },
              focusedIndex: d,
            ...
            _ = (function (e) {
              ...
              const p = (0, R.we)({
                ...
                m = (0, R.kp)(p.context, { enabled: !!o.click }),
                h = (0, R.iQ)(p.context, { enabled: !!o.focus }),
                g = (0, R.s9)(p.context),
                _ = (0, u.useRef)([]),
                f = (0, R.C1)(p.context, {
                  listRef: _,
              ...
              return {
                ...
                labelsRef: x,
                typingRef: S,
                initialFocus: o.virtualItemFocus ? -1 : void 0,
              };
            })({
              open: s.bOpen,
          ...
          return (0, r.jsx)(ie.Provider, {
            value: g,
            children: (0, r.jsx)(G, { state: _, children: t }),
          });
        },
        Option: function (e) {
            ...
            children: [
              o &&
                (0, r.jsxs)(X.s, {
                  ...
                  align: "center",
                  children: [
                    (0, r.jsx)(Q.S, { checked: p, variant: "dark" }),
                    s,
                  ],
                }),
              !o && s,
        ...
        Options: function (e) {
          ...
          return (0, r.jsx)(H, { ref: t, children: e.children });
        },
        Trigger: function (e) {
          const { children: t, render: s } = e,
            ...
            w = p ? Array.isArray(i) && i.length > 0 : !!i,
            A =
              w && f
      ...
      const re = Object.assign(function (e) {
        const {
          ...
          c = null != t,
          d = c ? i(t) : "";
        return (0, r.jsxs)(re.Root, {
          state: l,
          ...o,
          children: [
            (0, r.jsxs)(re.Trigger, {
              children: [
                c && (0, r.jsx)(re.Value, { children: d }),
                !c && (0, r.jsx)(re.Placeholder, { children: a }),
              ],
            }),
            (0, r.jsx)(re.Options, {
              children: l.rgOptions.map((e, t) =>
                (0, r.jsx)(re.Option, { value: e, children: i(e) }, t),
              ),
            }),
          ],
        });
      ...
      const ae = Object.assign(function (e) {
          ...
          if (d) {
            ...
            p =
              "ListFormat" in Intl
                ? new Intl.ListFormat(
                    (0, J.A)().languages[0].strISOCode,
                  ).format(e)
                : e.join(", ");
          }
          return (0, r.jsxs)(ae.Root, {
            state: c,
            ...l,
            children: [
              (0, r.jsxs)(ae.Trigger, {
                children: [
                  d && (0, r.jsx)(ae.Value, { children: p }),
                  !d && (0, r.jsx)(ae.Placeholder, { children: a }),
                ],
              }),
              (0, r.jsx)(ae.Options, {
                children: c.rgOptions.map((e, t) =>
                  (0, r.jsx)(ae.Option, { value: e, children: i(e) }, t),
                ),
              }),
            ],
          });
        }, ne),
        ie = (0, u.createContext)(null);
      function oe(e) {
        const t = (0, u.useContext)(ie);
      ...
      function ye() {
        return (0, r.jsxs)(me.Z, {
          className: ue.GameExplorerHeader,
          children: [
            (0, r.jsx)(me.Z, {
              className: ue.GameExplorerTitle,
              children: "Game Explorer",
            }),
            (0, r.jsx)(me.Z, {
              className: ue.GameExplorerDescription,
      ...
      function Ce(e) {
        const [t] = (0, he.t7)(e.selectedAppInfo.nAppID, {
          include_basic_info: !0,
        ...
        return (0, r.jsxs)("div", {
          className: ue.SelectedApp,
          children: [
            (0, r.jsx)("div", {
              className: ue.RemoveButttonContainer,
              children: (0, r.jsx)(p.$, {
                variant: "default",
                size: "1",
                color: "red",
            ...
            (0, r.jsx)("img", { className: ue.CapsuleImage, src: s }),
            (0, r.jsx)("div", {
              className: ue.WeightContainer,
              children:
                e.nNumSelected > 1 &&
                (0, r.jsx)(f, {
                  ...
                  max: 100,
                  onValueChange: (t) =>
                    e.onWeightChange(e.selectedAppInfo.nAppID, t, !1),
                  onValueSettled: (t) =>
                    e.onWeightChange(e.selectedAppInfo.nAppID, t, !0),
                }),
            }),
          ],
        });
      ...
      function ve(e) {
        ...
        return (0, r.jsx)("div", {
          className: ue.GameExplorerKnobs,
          children: (0, r.jsxs)("div", {
            className: ue.AppList,
            children: [
              (0, r.jsxs)("div", {
                className: ue.AppRow,
                children: [
              ...
              (0, r.jsxs)("div", {
                className: ue.OtherControls,
                children: [
                  (0, r.jsxs)("div", {
                    className: ue.OtherControl,
                    children: [
                      (0, r.jsx)("div", {
                        className: ue.ControlTitle,
                        children: "Popularity",
                      }),
                      (0, r.jsx)(A.I, {
                        ...
                        onValueChange: (t) =>
                          ((t) => {
                            switch (t) {
                              case "Similar":
                                e.onChange(
                                  { ...e.state, nPopularity: 0, bSimilar: !0 },
                                  !0,
                                );
                                break;
                              case "Any":
                                e.onChange(
                                  { ...e.state, nPopularity: 0, bSimilar: !1 },
                                  !0,
                                );
                                break;
                              case "Popular":
                                e.onChange(
                                  { ...e.state, nPopularity: 40, bSimilar: !1 },
                                  !0,
                                );
                                break;
                              case "Niche":
                      ...
                      (0, r.jsx)(A.I, {
                        ...
                        onValueChange: (t) =>
                          ((t) => {
                            switch (t) {
                              case "None":
                                e.onChange({ ...e.state, nSelfFactor: 0 }, !0);
                                break;
                              case "Some":
                                e.onChange({ ...e.state, nSelfFactor: 20 }, !0);
                                break;
                              case "Lots":
      ...
      function Ie(e) {
        const [t] = (0, he.G6)(e.nAppID, xe.c6.qI, Se.Xh);
        return t
          ? (0, r.jsxs)("div", {
              className: ue.CapsuleContainer,
              children: [
                (0, r.jsx)(_e.W, {
                  capsule: { id: e.nAppID },
                  imageType: "library",
                ...
                (0, r.jsxs)("div", {
                  className: ue.Distance,
                  children: [
                    `${(100 * e.fDistance).toFixed(2)}%`,
                    (0, r.jsx)("div", {
                      className: ue.StartExplore,
                      children: (0, r.jsx)(p.$, {
                        variant: "default",
                        size: "1",
                        color: "green",
      ...
      function je(e) {
        return 0 == e.arrNearApps.length
          ...
          : (0, r.jsx)("div", {
              className: (0, de.A)(
                ue.GameExplorerResults,
                e.bIsPending && ue.Pending,
              ),
      ...
      function we() {
        return (0, r.jsxs)(me.Z, {
          className: ue.PersonalCalendarLoginPrompt,
          children: [
            (0, pe.we)("#PersonalCalendar_LoginPrompt"),
            (0, r.jsx)("button", {
              onClick: le.vg,
              className: ue.LoginButton,
              children: (0, pe.we)("#Login_SignIn"),
            }),
          ],
        });
      }
      function Ae(e) {
        const [t] = (0, he.t7)(e.nAppID, {
          include_basic_info: !0,
          include_assets_without_overrides: !0,
        });
        if (!t) return null;
        ...
        return (0, r.jsxs)("div", {
          className: ue.AppSelectorResult,
          onPointerDown: () => e.onClick(e.nAppID),
          children: [
            (0, r.jsx)("img", { className: ue.Logo, src: s }),
            (0, r.jsx)("div", {
              className: ue.RightSide,
              children: t.GetName(),
            }),
          ],
        });
      ...
      const Re = u.forwardRef(function (e, t) {
          const s = (0, ge.T3)(e.strSearch, null, 10),
            n = e.fnSetResultApps;
          return (
            u.useEffect(() => {
            ...
            (0, r.jsx)("div", {
              className: (0, de.A)(
                ue.AppSelectorResults,
                s.data?.rgItemIDs.length > 0 && ue.Show,
              ),
              ref: t,
        ...
        Ne = (e) => {
          ...
          return (0, r.jsxs)("div", {
            className: ue.AppSelector,
            children: [
              (0, r.jsx)("input", {
                type: "text",
                className: (0, de.A)(ue.ValueInput, g && ue.Disabled),
                value: t,
                onChange: (e) => {
                  var r;
                  (r = e.target.value) != t &&
                    (s(r), a(Date.now()), setTimeout(m, 300));
                },
                onKeyDown: (e) =>
                  ((e) => {
                    switch (e) {
        ...
        Be = (e) => {
          const t = c().data,
            s = t?.appids ?? [];
          return (0, r.jsx)("div", {
            className: ue.AppPlayedSelector,
            children: (0, r.jsx)(re, {
              options: s,
              size: "1",
              selectedValue: 0,
              onSelectionChange: (t) => e.fnSelectAppID(t),
              getOptionLabel: (e) =>
                0 == e
                  ? "Select a recent game to add it"
                  : t?.names[t?.appids.indexOf(e)],
            }),
          });
        },
        Pe = function () {
          const e = (function (e) {
              ...
              return {
                arrSelectedAppInfos: t
                  .map((e) => Number(e))
                  .map((e, t) => ({ nAppID: e, nWeight: Number(s[t]) })),
                nSelfFactor: Number(e?.selffactor ?? "0"),
          ...
          return (0, r.jsx)(ce.Ay, {
            ...
            children: (0, r.jsx)(d.Y, {
              children: (0, r.jsx)(me.Z, {
                className: (0, de.A)(
                  ue.GameExplorerApp,
                  c.isFetching && ue.Refreshing,
                ),
                children: (0, r.jsxs)(me.Z, {
                  className: ue.GameExplorerContainer,
                  children: [
                    (0, r.jsx)(ye, {}),
                    !i.iA.steamid && (0, r.jsx)(we, {}),
                    (0, r.jsx)(ve, {
                      state: t,
                      onChange: (e, t) => {
    ...
    54796: (e, t, s) => {
          ...
          do {
            ...
            if (
              (t < this.m_Length &&
                ...
                (r = t),
              s < this.m_Length &&
                this.m_fnCompare(this.m_Heap[r], this.m_Heap[s]) > 0 &&
                (r = s),
              r == e)
            )
              break;
      ...
      class h {
        ...
        async FindPath(e, t, s) {
          ...
          for (; r.length > 0 && c < s; ) {
            ...
            c++, this.m_fnIterationCallback && this.m_fnIterationCallback();
          }
      ...
      (0, a.Cg)([c.oI], I.prototype, "OnDisplayClicked", null),
        (0, a.Cg)([c.oI], I.prototype, "UpdateAppSuggestions", null),
        (0, a.Cg)([c.oI], I.prototype, "OnKeyUp", null);
      class j extends _.Component {
        render() {
            ...
            return (0, r.jsx)("div", { className: S.SimilarApp });
          {
            ...
            if (this.props.score) {
              t.push(
                (0, r.jsx)("div", { className: S.Spacer }, "score-spacer"),
              );
              const e = Math.round(100 * this.props.score).toString() + "%";
              t.push(
                (0, r.jsx)(
                  "div",
                  { className: S.Score, children: e },
                  "score-value",
                ),
              );
            }
        ...
        render() {
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              ...
              (0, r.jsx)("div", { className: S.SimilarApps, children: t }),
            ],
          });
        }
      };
      ...
      let R = class extends _.Component {
        ...
        render() {
          let e = [
            {
              label: (0, r.jsx)("div", { children: "Plus" }, "Plus"),
              data: "Plus",
            },
            {
              label: (0, r.jsx)("div", { children: "Minus" }, "Minus"),
              data: "Minus",
            },
          ];
          return (0, r.jsxs)("div", {
            ...
            children: [
              ...
              (0, r.jsx)(I, { fnOnSelection: this.OnSelectedApp }),
            ],
          });
        }
      };
            ...
            .then((e) => {
              if (
                ...
                for (let s = 1; s < this.operands.length; s++) {
                  const r = e.data[s].components.map((e) => parseFloat(e));
      ...
      let B = class extends _.Component {
        ...
        render() {
          const e =
            ...
            t = e ? S.ComputeButton : (0, v.A)(S.ComputeButton, S.Disable);
          let s = null;
          s = this.in_progress
            ? (0, r.jsx)("div", {
      ...
      function P() {
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsx)("div", { className: S.Spacer }),
            (0, r.jsx)("h1", { children: "Pathfinder" }),
            (0, r.jsx)(B, {}),
          ],
        });
      }
      ...
      class U extends L.Message {
        ...
        constructor(e = null) {
          super(),
            U.prototype.tag_score_factor || T.Sg(U.M()),
            ...
            H.sm_m ||
              (H.sm_m = {
                ...
                fields: {
                  ...
                  ids: { n: 3, c: E.O4, r: !0, q: !0 },
                  options: { n: 4, c: U },
                  debug: { n: 5, br: T.qM.readBool, bw: T.gp.writeBool },
                  include_owned_games: {
                    n: 6,
                    br: T.qM.readBool,
                    bw: T.gp.writeBool,
            ...
            V.sm_m ||
              (V.sm_m = {
                ...
                fields: {
                  ...
                  weight: { n: 3, br: T.qM.readDouble, bw: T.gp.writeDouble },
      ...
      class $ extends L.Message {
        ...
        constructor(e = null) {
          super(),
            $.prototype.cluster_id || T.Sg($.M()),
            L.Message.initialize(this, e, 0, -1, [5, 6, 7], null);
        }
        static sm_m;
        static sm_mbf;
        static M() {
          return (
            $.sm_m ||
              ($.sm_m = {
                proto: $,
                fields: {
                  cluster_id: { n: 1, br: T.qM.readInt32, bw: T.gp.writeInt32 },
                  playtime_forever: {
                    n: 2,
                    br: T.qM.readInt32,
                    bw: T.gp.writeInt32,
                  ...
                  similar_items: { n: 7, c: E.vB, r: !0, q: !0 },
      ...
      class ee {
        ...
        LoadPlaytimeClusters(e, t, s, r) {
          return new te(this.m_SteamInterface, e, t, s, r);
        }
      }
      class te {
        ...
        ReadCluster(e, t) {
          let s;
          return (
            t && (s = e.similar_items().map((e) => X.A.Get().ReadItem(e, t))),
            {
                ...
                (0, r.jsx)(ie.tH, {
                  children: (0, r.jsxs)("div", {
                    ...
                    children: [
                      (0, r.jsxs)("div", {
                        children: [
                          (0, r.jsx)("b", { children: "Total Playtime:" }),
                          " ",
                      ...
                      (0, r.jsxs)("div", {
                        children: [
                          (0, r.jsx)("b", { children: "Last Played:" }),
                          " ",
                          (0, re.$z)(t.rtLastPlayed),
                          " ",
                        ],
                      }),
                      (0, r.jsxs)("div", {
                      ...
                      (0, r.jsxs)("div", {
                        children: [
                          (0, r.jsx)("b", { children: "Popularity Score:" }),
                          " ",
      ...
      class ve {
        ...
        UpdateLoginResult(e) {
          if (!e)
            return (
              ...
              void (this.m_strErrorMessage = (0, re.we)(
                "#ConnectionTrouble_FailedToConnect",
              ))
            );
          if (e.login_complete) {
            if (((this.m_eCurrentStep = ye.Complete), this.m_fnLoginComplete)) {
              let t = {
            ...
            (this.m_strErrorMessage = e.message || ""),
              ...
              e.requires_twofactor
                ? (this.UpdateCaptchaURL("-1"),
                  this.m_eCurrentStep != ye.TwoFactorCode ||
                ...
                : e.captcha_needed && e.captcha_gid
                  ? ((this.m_eCurrentStep = ye.AccountName),
                  ...
                  : e.emailauth_needed
                    ? (e.emaildomain && (this.m_strEmailDomain = e.emaildomain),
                      ...
                      this.m_eCurrentStep != ye.EmailCode ||
                        this.m_strErrorMessage ||
                        ((this.m_strErrorMessage = (0, re.we)(
                          "#MobileLogin_IncorrectSteamGuard",
                        )),
        ...
        async RefreshCaptcha() {
          let e = await (0, Se.Cr)(this.m_strBaseURL);
      ...
      (0, a.Cg)([l.sH], ve.prototype, "m_bRequestInFlight", void 0),
        (0, a.Cg)([l.sH], ve.prototype, "m_userFields", void 0),
        (0, a.Cg)([l.sH], ve.prototype, "m_eCurrentStep", void 0),
        (0, a.Cg)([l.sH], ve.prototype, "m_strErrorMessage", void 0),
        (0, a.Cg)([l.sH], ve.prototype, "m_strEmailDomain", void 0),
        (0, a.Cg)([l.sH], ve.prototype, "m_strCaptchaURL", void 0),
        (0, a.Cg)([l.sH], ve.prototype, "m_eSteamGuardCodeError", void 0),
        (0, a.Cg)([be.o], ve.prototype, "DoLogin", null),
        (0, a.Cg)([l.XI.bound], ve.prototype, "UpdateCaptchaURL", null);
      let Ie = class extends _.Component {
        m_manager;
        constructor(e) {
          super(e),
            (this.m_manager = new ve(this.props.baseURL)),
            ...
            (e =
              1 == this.state.nNameSize
                ...
                : 2 == this.state.nNameSize
                  ...
                  : xe().DefaultNAme),
            (0, r.jsxs)("div", {
              className: xe().AccountPasswordPanel,
              children: [
                (0, r.jsx)("div", {
                  className: xe().SigninTitle,
                  children: (0, re.we)("#Login_SignInTitle"),
                }),
                (0, r.jsxs)("form", {
                  className: xe().AccountPasswordForm,
                  onSubmit: this.OnSubmit,
                  children: [
                    (0, r.jsx)(b.pd, {
                      autoFocus: this.props.autoFocus,
                      className: (0, v.A)(xe().AccountNameLabel, e),
                      label: (0, re.we)("#Login_AccountName"),
                      type: "text",
                      value: s.GetUserName(),
                      focusOnMount: !0,
                      maxLength: 64,
                    ...
                    (0, r.jsx)(b.pd, {
                      className: (0, v.A)(xe().PasswordDots, t),
                      label: (0, re.we)("#Login_Password"),
                      type: "password",
                      autoComplete: "off",
                      maxLength: 64,
                      size: 64,
                    ...
                    (0, r.jsx)(b.Yh, {
                      className: xe().RememberMeCheck,
                      label: (0, re.we)("#Login_RememberMe"),
                      disabled: !1,
                      onChange: () => this.OnChangeRememberPass,
                      checked: s.GetRememberPassword(),
                    }),
                    s.GetCaptchaURL() && (0, r.jsx)(Ae, { manager: s }),
                    (0, r.jsx)(b.jn, {
                      disabled: this.props.manager.IsRequestInFlight(),
                      children: (0, re.we)("#Login_SignIn").toLocaleUpperCase(),
                    }),
                  ],
                }),
                (0, r.jsx)("a", {
                  className: xe().NeedHelpLink,
                  href: o.TS.HELP_BASE_URL,
                  children: (0, re.we)("#Login_ForgotPassword"),
                }),
                (0, r.jsx)("div", { className: xe().LoginCreateSeperator }),
                (0, r.jsxs)("div", {
                  className: xe().SteamUpsellContainer,
                  children: [
                    (0, r.jsx)("div", {
                      className: xe().SteamUpsell,
                      children: (0, re.we)("#Login_NoSteamAccount"),
                    }),
                    (0, r.jsx)("div", {
                      className: xe().CreateAccountLink,
                      children: (0, r.jsx)("a", {
                        href: `${o.TS.STORE_BASE_URL}join/`,
                        children: (0, re.we)("#Login_CreateAccount"),
                      }),
                    }),
                  ],
                }),
      ...
      let Ae = class extends _.Component {
        ...
        render() {
          ...
          return (0, r.jsxs)("div", {
            className: xe().CaptchaContainer,
            children: [
              (0, r.jsxs)("div", {
                className: xe().CaptchaBlock,
                children: [
                  (0, r.jsxs)("div", {
                    className: xe().CaptchaImageAndInput,
                    children: [
                      (0, r.jsx)("div", {
                        className: xe().CaptchaImageBox,
                        children: (0, r.jsx)("img", {
                          className: xe().CaptchaImage,
                          src: e.GetCaptchaURL(),
                        }),
                      }),
                      (0, r.jsx)(b.pd, {
                        className: xe().CaptchaInput,
                        type: "text",
                        autoComplete: "off",
                        maxLength: 6,
                  ...
                  (0, r.jsx)("div", {
                    className: xe().ErrorMessage,
                    children: (0, re.we)("#Login_CaptchaVerification"),
                  }),
                ],
              }),
              (0, r.jsx)("div", {
                children: (0, r.jsx)("span", {
                  className: xe().RefreshCaptchaText,
                  onClick: this.RefreshCaptcha,
                  children: (0, re.we)("#Login_RefreshCaptcha"),
                }),
              }),
            ],
          });
      ...
      let Re = class extends _.Component {
        ...
        OnChangeAuthCode(e) {
          this.props.authtype == ye.TwoFactorCode
        ...
        render() {
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              (0, r.jsx)(b.JU, { children: (0, re.we)("#Login_SigningIn") }),
              (0, r.jsx)("div", {
              ...
              (0, r.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, r.jsxs)("form", {
                    ...
                    children: [
                      (0, r.jsx)(b.pd, {
                        className: (0, v.A)(xe().AccountName),
      ...
      const Be = [
        ...
        {
          path: "clustering",
          render: (e) => (0, r.jsx)(le, { SteamInterface: e.SteamInterface }),
          name: "Tag Clustering",
          requires_login: !0,
        },
      ];
    ...
    1593: (e, t, s) => {
      ...
      var r = s(7850),
        ...
        f = s(35380);
      const x = (e) => {
          const t = (0, f.$5)(e.nAppID),
            s = (0, n.lv)(t),
            a = (0, n.J$)(t);
          if (!s.data || !a.data) return null;
          const i = (0, l.l)(s.data, "header");
          return (0, r.jsxs)("div", {
            className: g.AppCapsule,
            children: [
              (0, r.jsx)(d.u, {
                id: t,
                children: (0, r.jsx)("img", { className: g.Image, src: i }),
              }),
              (0, r.jsxs)("div", {
          ...
          return (
            o.useEffect(() => {
              (async () => {
                ...
                try {
                  const e = await i().get(
                    `${h.TS.STORE_BASE_URL}recommenderdemos/getlist`,
          ...
          return (
            o.useEffect(() => {
              (async () => {
                ...
                try {
                  const e = await i().get(
                    `${h.TS.STORE_BASE_URL}recommenderdemos/getfests`,
                    { params: t, timeout: 1e4 },
                  );
                  s(e.data);
                } catch (e) {
            ...
            children: (0, r.jsxs)("div", {
              ...
              children: [
                ...
                (0, r.jsx)(S, {
                  ...
                  strSubtitle: (0, m.we)("#RecommenderDemos_HotWishlists_Desc"),
                }),
                (0, r.jsx)(S, {
                  nAccountID: s,
                  bExclude: l,
