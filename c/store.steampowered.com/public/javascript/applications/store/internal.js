(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [9456],
  {
        ...
        const [_, _] = _.useState(
          ...
          _ = (_, _, _) => {
            ...
            if (
              ...
              const _ = _.map((_) => (_.nAppID != _ ? _.nWeight : null)).filter(
                  (_) => null != _,
                ),
        ...
        _ = function () {
          const _ = (function (_) {
              const _ = _.appids?.split(",").filter((_) => "0" != _) ?? [],
                _ = _.weights?.split(",").filter((_) => "0" != _) ?? [];
              return {
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
        ...
        Init(_) {
          ...
          _()
            ...
            .then((_) => {
              if (_.data) {
                let _ = [];
                for (const _ of _.data) "default" != _ && _.push(_);
      ...
      (0, _._)([_._], _.prototype, "rgModelNames", void 0),
        (0, _._)([_._], _.prototype, "GetNeighbors", null),
        (0, _._)([_._], _.prototype, "EstimateCosts", null);
      class _ {
        m_fnCompare;
        m_Heap = [];
        m_Length = 0;
        ...
        BubbleDown() {
          ...
          do {
              ...
              break;
            {
              ...
              (this.m_Heap[_] = this.m_Heap[_]), (this.m_Heap[_] = _), (_ = _);
            }
        ...
        BubbleUp(_) {
          ...
          for (; _ > 0; ) {
            const _ = (_ - 1) >> 1;
            if (!(this.m_fnCompare(this.m_Heap[_], this.m_Heap[_]) > 0)) break;
            {
              const _ = this.m_Heap[_];
              (this.m_Heap[_] = this.m_Heap[_]), (this.m_Heap[_] = _), (_ = _);
            }
          ...
          for (; _.length > 0 && _ < _; ) {
            ...
            if (_.length > 0) {
              let _ = await this.m_fnEstimateCosts(
                __webpack_require__.map((_) => _.node),
                _,
              );
          ...
          super(_),
            this.props.appidInitial &&
              (_._.EnsureAppInfoForAppIDs([this.props.appidInitial]).then(
                () => {
                  _._.GetAppInfo(this.props.appidInitial);
                  this.setState({
          ...
          _ && 0 != _
            ? _._.EnsureAppInfoForAppIDs([_]).then(() => {
                ...
                this.setState({
                  ...
                  this.props.fnOnSelection && this.props.fnOnSelection(_, this);
              })
            : this.setState({
                appid: 0,
                appinfo: null,
      ...
      (0, _._)([_._], _.prototype, "OnDisplayClicked", null),
        (0, _._)([_._], _.prototype, "UpdateAppSuggestions", null),
      ...
      (0, _._)([_._], _.prototype, "selected_app", void 0),
        (0, _._)([_._], _.prototype, "similar_apps", void 0),
        (0, _._)([_._], _.prototype, "similarity_scores", void 0),
        (0, _._)([_._], _.prototype, "similarity_model", void 0),
        (0, _._)([_._], _.prototype, "OnSelectedApp", null),
        (0, _._)([_._], _.prototype, "SetSelectedApp", null),
        (0, _._)([_._], _.prototype, "OnModelChanged", null),
        (_ = (0, _._)([_._], _));
      let _ = class extends _.Component {
        selected_app = void 0;
      ...
      (0, _._)([_._], _.prototype, "selected_app", void 0),
        (0, _._)([_._], _.prototype, "selected_operator", void 0),
        (0, _._)([_._], _.prototype, "OnSelectedApp", null),
        (0, _._)([_._], _.prototype, "OnSelectedOperator", null),
        (_ = (0, _._)([_._], _));
      let _ = class extends _.Component {
        operands = [];
        similarity_model = "default";
            ...
            .then((_) => {
              if (
                ...
                for (let _ = 1; _ < this.operands.length; _++) {
                  ...
                  "Plus" == this.operands[_].operator
                    ? (_ = _.map((_, _) => _ + _[_]))
                    : "Minus" == this.operands[_].operator
                      ? (_ = _.map((_, _) => _ - _[_]))
                      : console.log(
      ...
      (0, _._)([_._], _.prototype, "operands", void 0),
        ...
        (0, _._)([_._], _.prototype, "similarity_scores", void 0),
        (0, _._)([_._], _.prototype, "OnModelChanged", null),
        (0, _._)([_._], _.prototype, "OnAddOperand", null),
        (0, _._)([_._], _.prototype, "OnOperandChanged", null),
        (_ = (0, _._)([_._], _));
      let _ = class extends _.Component {
        constructor(_) {
          super(_), (0, _._)(this);
      ...
      (0, _._)([_._], _.prototype, "app_start", void 0),
        ...
        (0, _._)([_._], _.prototype, "in_progress", void 0),
        (0, _._)([_._], _.prototype, "progress_iteration", void 0),
        (0, _._)([_._], _.prototype, "found_path", void 0),
        (0, _._)([_._], _.prototype, "IterationCallback", null),
        (0, _._)([_._], _.prototype, "Pathfind", null),
      ...
      !(function (_) {
        (_.PrioritizeAppsForUser = function (_, _) {
          ...
          (_.IdentifyClustersFromPlaytime = function (_, _) {
            return _.SendMsg(
        ...
        ReadCluster(_, _) {
          ...
          return (
            _ && (_ = _.similar_items().map((_) => _._.Get().ReadItem(_, _))),
            {
              ...
              rgSimilarItems: __webpack_require__.filter((_) => !!_),
        ...
        const _ = _.useMemo(() => {
          ...
          _ = (function (_, _, _, _ = 1, _ = null, _ = []) {
            ...
            return (
              _.useEffect(() => {
                if ((_(null), _))
                  return _.LoadPlaytimeClusters(
                    _,
                    _,
                    _,
                    _,
                  ).RegisterOnReadyCallback(_).Unregister;
              }, [_, _, _, ..._]),
              _
            );
          })(
      ...
      !(function (_) {
        ...
        (function (_) {
          (_[(_.None = 0)] = "None"), (_[(_.InvalidCode = 1)] = "InvalidCode");
        })(_ || (_ = {}));
      class _ {
        m_strBaseURL = "";
        m_strOAuthClientID = "";
        ...
        m_userFields = void 0;
        m_eCurrentStep = _.AccountName;
        m_strErrorMessage = "";
        m_strEmailDomain = "";
        m_strCaptchaURL = "";
        m_eSteamGuardCodeError = _.None;
        constructor(_, _) {
          (0, _._)(this),
            (this.m_strBaseURL = _),
        ...
        UpdateLoginResult(_) {
          if (!_)
            return (
              ...
              void (this.m_strErrorMessage = (0, _._)(
                "#ConnectionTrouble_FailedToConnect",
              ))
            );
          if (_.login_complete) {
            if (((this.m_eCurrentStep = _.Complete), this.m_fnLoginComplete)) {
              let _ = {
                ...
                : _.captcha_needed && _.captcha_gid
                  ...
                  : _.emailauth_needed
                    ? (_.emaildomain && (this.m_strEmailDomain = _.emaildomain),
                      ...
                      this.m_eCurrentStep != _.EmailCode ||
                        this.m_strErrorMessage ||
                        ((this.m_strErrorMessage = (0, _._)(
                          "#MobileLogin_IncorrectSteamGuard",
                        )),
        ...
        async RefreshCaptcha() {
          ...
          _ ? this.UpdateCaptchaURL(_) : console.log("Failed to get captcha");
        }
        UpdateCaptchaURL(_) {
          (this.m_userFields.gidCaptcha = _),
            (this.m_userFields.strCaptchaText = ""),
            (this.m_strCaptchaURL =
              "-1" != _ ? (0, _._)(this.m_strBaseURL, _) : "");
        }
      }
      (0, _._)([_._], _.prototype, "m_bRequestInFlight", void 0),
        (0, _._)([_._], _.prototype, "m_userFields", void 0),
        (0, _._)([_._], _.prototype, "m_eCurrentStep", void 0),
        (0, _._)([_._], _.prototype, "m_strErrorMessage", void 0),
        (0, _._)([_._], _.prototype, "m_strEmailDomain", void 0),
        (0, _._)([_._], _.prototype, "m_strCaptchaURL", void 0),
        (0, _._)([_._], _.prototype, "m_eSteamGuardCodeError", void 0),
        (0, _._)([_._], _.prototype, "DoLogin", null),
        (0, _._)([_._.bound], _.prototype, "UpdateCaptchaURL", null);
      let _ = class extends _.Component {
        m_manager;
        constructor(_) {
          super(_),
      ...
      (0, _._)([_._], _.prototype, "OnSubmit", null),
        (0, _._)([_._], _.prototype, "OnChangeName", null),
        (0, _._)([_._], _.prototype, "OnChangePassword", null),
        (0, _._)([_._], _.prototype, "OnChangeRememberPass", null),
        (_ = (0, _._)([_._], _));
      let _ = class extends _.Component {
        OnCaptchaText(_) {
      ...
      (0, _._)([_._], _.prototype, "OnCaptchaText", null),
        (0, _._)([_._], _.prototype, "RefreshCaptcha", null),
        (_ = (0, _._)([_._], _));
      let _ = class extends _.Component {
        OnSubmit(_) {
          _.preventDefault(), this.props.manager.DoLogin();
      ...
      (0, _._)([_._], _.prototype, "OnSubmit", null),
        (0, _._)([_._], _.prototype, "OnChangeAuthCode", null),
        (_ = (0, _._)([_._], _));
      var _ = __webpack_require__("chunkid");
      const _ = [
        {
      ...
      function _(_) {
        ...
        if (
          ((0, _.useEffect)(() => {
            _.Init(_), __webpack_require__(!0);
          }, [_]),
          !_)
        )
          return (0, _.jsx)("div", {
            ...
            _.useEffect(() => {
              (async () => {
                ...
                try {
                  ...
                  __webpack_require__(_.data.appids), _(_.data.weights);
                } catch (_) {
