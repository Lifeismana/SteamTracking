      ...
      return {
        filteredWishlist: {
          ...
          items: _.items.filter((_) => {
            ...
            if (!_) return !1;
            if (_.name.indexOf(_) !== -1)
              return _(_, _.name), _.cAppNameMatches++, !0;
...
var _ = `tPinc5p8M44-`,
  ...
  _ = 16;
function _(_) {
  let { appid: _, steamid: _, onClose: _, filteredCategoryIDs: _ } = _,
    [_, _] = _.useState([]),
    _ = _(),
    { data: _ } = _({
      appid: _,
